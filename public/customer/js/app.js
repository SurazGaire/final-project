                ...
                var t = "dropdown",
                    ...
                    g = function () {
                        ...
                        return g.toggle = function () {
                            ...
                            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || e(t.target).closest(p.MENU).length)) : c.test(t.which)) && (t.stopPropagation(), !this.disabled && !e(this).hasClass(f.DISABLED))) {
