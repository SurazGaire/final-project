        ...
        <div class="sidebar-brand-text mx-3">Admin</div>
           ...
           <a class="nav-link collapsed" href="" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
             ...
             <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
               <div class="bg-white py-2 collapse-inner rounded">
                   <a class="collapse-item" href="{{ route('employees') }}">View all Employees</a>
                 <a class="collapse-item" href="buttons.html">Added By Admin</a>
                 <a class="collapse-item" href="cards.html">Self Registered Employees</a>
               </div>
             </div>
           </li>
           ...
           <li class="nav-item">
             ...
             <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
               ...
               <a class="collapse-item" href="#">Customers Record</a>
