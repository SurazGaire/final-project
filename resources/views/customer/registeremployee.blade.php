                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-2">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" id="register" action="{{ route('employee.insert') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
...
<script src="{{URL::to('/')}}/public/customer/js/jquery.validate.js"></script>
<script src="{{URL::to('/')}}/public/customer/js/jquery.passtrength.js"></script>
