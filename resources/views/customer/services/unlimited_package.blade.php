...
<script>
            ...
            "eventHandler": {
                onSuccess (payload) {
                    ...
                    console.log(payload);
                            $.ajax({
                                type: "POST",
                                url: "{{ route('payment.verification.unlimited_package') }}",
                                data:{
                                ...
                                $.ajax({
                                    type: "POST",
                                    url : "{{ route('order.make.unlimited_package') }}",
                                    data: {
                                        response : response,
        ...
        btn.onclick = function () {
            checkout.show({amount:  {{ $services->upack }}*100 });
        }
    </script>
